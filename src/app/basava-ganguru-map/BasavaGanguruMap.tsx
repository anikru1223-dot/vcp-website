...
<title>Basavanaganguru · Sy. No. 157/1, 157/6, 157/9, 157/10 · Interactive Map</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Sora:wght@300;400;600;700&family=IBM+Plex+Mono:wght@400;500;600;700&family=Oswald:wght@500;600;700&display=swap" rel="stylesheet">
<style>
:root{
...
<body class="lit real intro-active">
...
export default function LayoutMap() {
    ...
    return (
        <div style={{ width: "100%", height: "100vh", overflow: "hidden" }}>
            <iframe
                ref={iframeRef}
                title="Basavanaganguru Layout Map"
                style={{
                    width: "100%",
                    height: "100%",
                    border: "none",

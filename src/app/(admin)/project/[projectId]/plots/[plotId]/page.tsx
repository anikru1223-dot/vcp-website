...
export default function PlotDetailsPage() {
    ...
    // Temporary data (Later from Supabase)
    const plot = {
        id: plotId,
        number: plotId,
        status: "Available",
        ...
        <main className="min-h-screen bg-[#0B0B0F] text-white pb-24">
            ...
            <div className="sticky top-0 z-20 bg-[#111116] border-b border-zinc-800 px-5 py-5">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            onClick={() =>
                                router.push(`/project/${projectId}/plots`)
                            }
            ...
            <div className="space-y-5 p-5">
                ...
                <div className="grid grid-cols-1 gap-4">
                    ...
                    <button className="rounded-xl bg-green-600 py-4 font-semibold">

                        Mark Available

                    </button>

                    <button className="rounded-xl bg-yellow-500 py-4 font-semibold text-black">

                        Reserve Plot

                    </button>

                    <button className="rounded-xl bg-red-600 py-4 font-semibold">
